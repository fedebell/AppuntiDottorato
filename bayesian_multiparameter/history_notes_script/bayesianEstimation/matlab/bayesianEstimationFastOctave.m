...
vectRandom=randsample(linspace(1, numParticles, 1), numParticles2, true, weights);
...
if(debug == 1)
    ...
    disp(["cos: ", num2str(counterPhase(1))]);
    disp(["sin: ", num2str(counterPhase(2))]);
    
    disp("---------------------------");
    
    disp(est);
    
    disp(["True Value: ", num2str(trueTheta)]);
...
array = adaptiveBayesian(1000, sizeSpace, 20000, a, resample_threshold, Q, numGuesses, theta, s, phases, 1);
