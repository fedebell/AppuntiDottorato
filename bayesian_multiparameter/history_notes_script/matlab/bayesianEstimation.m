...
adaptiveBayesian(numParticles, sizeSpace, N, a, resample_threshold, Q, numGuesses, theta, s, phases, debug);
...
for N=2:4:100 
    for counter = 1:1:Num2
        [results(N, counter, 1:sizeSpace), results(N, counter, sizeSpace+1)] = adaptiveBayesian(numParticles, sizeSpace, N, a, resample_threshold, Q, numGuesses, theta, s, phases, 0);
    end
end
...
for N=1000:400:10000 
    for counter = 1:1:Num2
        [results(N, counter, 1:sizeSpace), results(N, counter, sizeSpace+1)] = adaptiveBayesian(numParticles, sizeSpace, N, a, resample_threshold, Q, numGuesses, theta, s, phases, 0);
    end
end

for N=10000:2000:30000 
    for counter = 1:1:Num2
        [results(N, counter, 1:sizeSpace), results(N, counter, sizeSpace+1)] = adaptiveBayesian(numParticles, sizeSpace, N, a, resample_threshold, Q, numGuesses, theta, s, phases, 0);
    end
end
...
%Debig mode
if(debug == 1)
    screenShoots = zeros(numParticles, sizeSpace+1, maxExp);
    listEsperiment = zeros(maxExp, 2);
end
