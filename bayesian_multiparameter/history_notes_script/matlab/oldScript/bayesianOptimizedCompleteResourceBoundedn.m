%This version of the software stops when it reaches the desired number of
...
%phases = pi/(2*16)*linspace(1, 16, 16);
%phases = [0 pi/2];
...
p = (1+0.9*cos(trueTheta*quantumResource+controlPhase))/2;
